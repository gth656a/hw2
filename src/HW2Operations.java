 ...
 *         two cases. - You may only use up to 2 if/else-if statements. -
 ...
 *         case-statements using switch. (see the next point) - Your code should
 *         be concise and simple. None of these functions should be more than
 *         about 5-7 lines of code. If your code is any longer than this, then
 *         you are doing it wrong or inefficiently.
 * 
